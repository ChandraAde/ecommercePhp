...
<div class="container">
    <div class="content">
                    ...
                    if ($getPro) {
                        ...
                        while ($result = $getPro->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>Rp. <?php echo $result['price'] . ".00"; ?></td>
                ...
                <table>
                    <tr>
                        <td>
                            <ul>
                                <li>BNI : 0797677</li>
                                <li>BRI : 6866861268</li>
                                <li>Konfirmasi Ke nomor Wa: 08555</li>
                                <li>Apabila Telah Melakukan Pembayaran <br> Dengan Bank diatas</li>
                            </ul>
                        </td>
                    </tr>
                </table>
        ...
        <div class="row justify-content-md-center">
            <a class="btn btn-primary" href="?orderid=order">Pesan Sekarang</a>
        </div>
    </div>
